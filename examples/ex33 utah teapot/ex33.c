...
const char* part[] = {"Rim","Upper Body","Lower Body","Bottom","Lid Handle","Lid","Upper Handle","Lower Handle","Spout Body","Spout Tip","Teapot"};
const char* text[] = {"Wireframe","Hidden Line Wireframe","Solid","Solid Lit","Textured","Textured Lit","Manual Solid","Manual with Normals","Manual with Textures"};
